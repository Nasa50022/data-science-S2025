...
- Are there any sources of *real* uncertainty in the percent occupied you calculated?
  - Islanders will die, new ones will be born and they will move around changing this numbers day to day so yes there are sources of real uncertainty.
- Are there any sources of *erroneous* uncertainty in the percent occupied you calculated?
  - Yes im tired and i probably missed an empty house or two when scroll counting.
...
- Which sample---sequential or random---is more *representative* of all homes Helvig? Why?
  ...
  - (Write your 'why' here.) Random works best because while technically not a perfect solution a random sample is much more representative of all homes vs a sequential chunk bc it draws from all over the range of houses vs a small range of 25.
...
- Is there any reason that people with the same last name might tend to *live near each other*?
  - (Your response here) Perhaps they are familially related and thus like living near each other to make it easy to visit?
...
- Note that we used the *random* sample with the bootstrap procedure in this task. Could we use the bootstrap to make a confidence interval using the sequential sample (`df_sample_seq`) that would be representative of all of Helvig? Why or why not?
  - (Yes or no.) No
  - (Write your 'why' here.) Because the sequential data is not representative of the total range of houses in helvig as we have established and thus the confidence interval will be woefully innacurate.
