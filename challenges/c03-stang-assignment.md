...
- Is there “one true value” for the material properties of Aluminum?
  - No because these values change based on the type of alloy used and
    the thickness of the sample.
- How many aluminum alloys are in this dataset? How do you know?
  - 1 alloy is in this dataset because the only value in the alloy
    column was “al_24st”
- What angles were tested?
  - The angles measured (probably by a strain triple gauge arrangement
    offset by 45 degrees from each other) were 0, 45, 90 degrees.
- What thicknesses were tested?
  - 0.022 , 0.034, 0.064, 0.081 meters\* \*probably meters I really
    couldn’t find what units were used.
- How does the thickness relate to young’s modulus (E)?
  - Across all 3 values for each thickness when the thickness was
    increased compared to the previous thickness the youngs modulus
    decreased compared to the previous thickness. This means that the
    thicker the material is the lower its youngs modulus will be across
    all angles.
...
- So i was partially right. I must have not checked the data so
  carefully when parsing the lists on my own because it seems that the
  0.6 value is higher then expected across the board. But ignoring that
  outlier the general trend across all 3 angles is that a higher
  thickness corresponds to a lower young’s modulus.
...
- Does this graph support or contradict the claim above?
  - It (somewhat) contradicts the claim above because even though the
    data is super scattered and full of outliers and anomalous values
    the data (somewhat) suggests that Elasticity decreases the thinner
    the material gets which means its a property of the material that
    changes depending on the amount of material and this means it cannot
    be a intensive material property
