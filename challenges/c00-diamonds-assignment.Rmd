...
i thought a line plot wouldnt have it go down all the time but im not sure if there are data points at zero between the actual data or if I misconfigured the settings.
...
i was struggling to get proper labels working with the multi faceted plot.
