...
**Observations**:
waow its urine yellow color :D

There seems to be a general trend upwards as carat increases so does price. Additionally a lot of data points tend to group up around the whole number carat weights.
...
The plots generally seem to follow the trend displayed by the combined q1 graph. Notably fair seems to diverge slightly more then the rest and also has quite a few outliers.
